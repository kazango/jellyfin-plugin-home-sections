...
namespace Jellyfin.Plugin.HomeScreenSections.Controllers
{
    ...
    public class HomeScreenController : ControllerBase
    {
        ...
        {
            List<HomeScreenSectionInfo> sections = m_homeScreenSectionService.GetSectionsFromRequest(userId, language);
        ...
        public QueryResult<BaseItemDto> GetSectionContent(
            ...
            [FromQuery] string? language)
        {
            return m_homeScreenSectionService.GetSectionResults(userId, additionalData, sectionType, Request);
        }
